                    ...
                    <div id='slider-main'>
                        ...
                        <div id='caption-box'>
                            <p class='slide-caption active'>
                                During our book tour, we invited folks to get creative and use their sci-fi imaginations to visualize futures without violence or punishment.
                            </p>
                            <p class='slide-caption'>
                                We know that what people say should make us safe (like police, prisons, and borders) actually does the opposite.
                            </p>
                             
                            <p class='slide-caption'>
                                So we wanted to hear from our audiences - what would really make you feel safe?
                            </p>
                            
                            <p class='slide-caption'>
                                What would safety feel and sound and taste like? 
                            </p>
                            <p class='slide-caption'>
                                Here in our society in Germany, or on earth, or on other planets...
                            </p>
                            <p class='slide-caption'>
                                People wrote down a word or two/ a doodle or two on a piece of paper.
                            </p>
                            <p class='slide-caption'>
                                We snapped photos and posted them to our Twitter, Instagram and Facebook with the hashtags #WirklichSicher and #ReallySafe.
                            </p>
                        </div>
                    </div>
