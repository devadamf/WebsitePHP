<?php include('header.php'); ?>
    <div id='content'>
        <?php main_nav("seminar", TRUE); //top ?>

        <div class='content-main'>
            <div id='seminar-top'>
                <h2><span class='h2-underline'>Seminar</span></h2>
                <div id='seminar-top-sub'>
                    <p class='video-wrap-text'>
                        ...
                        <br/>
                        Because after New Years Eve in Köln, suddenly everybody cares about sexual violence, and after Orlando, suddenly everybody cares about queer folks and I say “Not in my name.”
                        <br/>
                        ...
                        <br/><br/>
                        ...I offered this seminar: “Feminism and the State: Carceral Feminisms and Transformative Alternatives,” at the Zentrum für transdisziplinäre Geschlechterstudien (Center for transdisciplinary Gender Studies) at Humboldt University. 
                        <br/><br/>
                        ...
                        <br/><br/>
                        (“Prison is not Feminist” button/poster in the image available <a href='https://marketplace.zibbet.com/nia-books-and-things/prison-is-not-feminist-poster'>here</a> from Project NIA)
                    </p>
                </div>
            </div>
            <!--
