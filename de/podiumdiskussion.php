<?php include('header.php'); ?>
    ...
    <div id='content'>
        ...
        <div class='content-main'>
            ...
            <div id='discussion-top'>
                ...
                <div id='discussion-top-sub'>
                    ...
                    <p class='video-wrap-text'>
                        Um die Debatten im Seminar auch einem breiteren Publikum zugänglich zu machen, gab es eine öffentliche Podiumsdiskussion mit den verschiedenen Aktivist*innen.<br/><br/>
        ...
        <?php main_nav("podiumdiskussion", FALSE); //top ?> 
